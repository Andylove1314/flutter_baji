...
class LindiGestureDetector2 extends StatefulWidget {
  ...
  @override
  State<LindiGestureDetector2> createState() => LindiGestureDetectorState();
}

class LindiGestureDetectorState extends State<LindiGestureDetector2> {
  ...
  @override
  void initState() {
    // Initialize the transformation matrix with the provided initial values
    matrix = Matrix4.identity()
      ..translate(widget.initialPosition.dx, widget.initialPosition.dy)
      ..rotateZ(widget.initialRotation)
      ..scale(widget.initialScale);
    recordScale = widget.initialScale;
  ...
  void onDragStart(details) {
    if (details is ScaleStartDetails) {
      ...
      centerOffset = getFocalPoint(widget.centerKey, widget.globalKey);
    }
...
Offset getFocalPoint(GlobalKey widgetKey, GlobalKey globalKey) {
