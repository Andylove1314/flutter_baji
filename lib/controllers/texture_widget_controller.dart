...
class TextureWidgetController extends GetxController {
  final isLoading = false.obs;
  final isCached = false.obs;
  final cachedPath = ''.obs;

  final _imageCacheManager = DefaultCacheManager();
  BjTextureDetail stickDetail;

  TextureWidgetController(this.stickDetail);
  ...
  /// 缓存sticker, 离线资源不缓存
  Future<String> cacheTexture(BjTextureDetail stickDetail) async {
  ...
  Future<void> checkCache(BjTextureDetail stickDetail) async {
    FileInfo? fileInfo =
